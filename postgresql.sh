...
# Optional: Enable external access - we use port mapping from localhost in vbox config
# IMPORTANT:
#           - avoid spaces before closing EOF when enabling
#           - use installed (9.5) postgres version bellow
